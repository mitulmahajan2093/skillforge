...
const MAIN_APP_URL = process.env.NEXT_PUBLIC_MAIN_APP_URL || "http://localhost:5173";
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[var(--color-ink-700)] bg-[var(--color-ink-900)]/85 backdrop-blur">
      <nav className="mx-auto flex max-w-4xl items-center justify-between px-4 py-4 sm:px-6">
        <Link href="/" className="flex items-center gap-2 font-[family-name:var(--font-display)] text-lg font-bold tracking-tight">
          ...
          SkillForge <span className="text-[var(--color-slate-400)] font-medium">/ Blog</span>
        </Link>
        <a
          href={MAIN_APP_URL}
